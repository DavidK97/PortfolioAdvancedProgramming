...
public class TreeSetMutationDemo {
    ...
    public static void main(String[] args) {
      ...
      //  students.forEach(System.out::println);
        ...
        // Vi kan ændre hvordan vores TreeSet skal sortere ved at bruge en Comparator
        Set<Student> studentsByName = new TreeSet<>(Comparator.comparing(Student::getName));
        studentsByName.add(new Student("Charlie", 3));
        studentsByName.add(new Student("Alice", 1));
        studentsByName.add(new Student("Bob", 2));
